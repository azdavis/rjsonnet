...
fn main() {
  let things = [
    ...
    (ident("ARRAY_BOOL"), q!(Data::Array(super::Array::new(Ty::BOOL)))),
    ...
    (ident("ARRAY_ANY"), q!(Data::Array(super::Array::new(Ty::ANY)))),
    (ident("SET_ANY"), q!(Data::Array(super::Array::set(Ty::ANY)))),
